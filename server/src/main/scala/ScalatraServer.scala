...
object ScalatraServer extends BasicScalaGenerator {
  def main(args: Array[String]) = generateClient(args)

  override def templateDir = "src/main/templates/scala-scalatra"

  val outputFolder = "scala-scalatra"
  ...
  additionalParams ++= Map(
    ...
    "tosPage" -> "http://helloreverb.com/terms",
