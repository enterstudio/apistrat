...
object JavaServer extends BasicJavaGenerator {
  def main(args: Array[String]) = generateClient(args)

  override def templateDir = "src/main/templates/java-server"

  val outputFolder = "java-jaxrs"
  ...
  override def supportingFiles = List(
    ...
    ("ApiResponseMessage.mustache", destinationDir + "/" + apiPackage.get.replaceAll("\\.", "/"), "ApiResponseMessage.java"),
    ...
    ("pom.mustache", outputFolder, "pom.xml"),
